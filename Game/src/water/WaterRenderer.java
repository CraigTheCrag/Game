...
public class WaterRenderer {
	...
	public WaterRenderer(Loader loader, WaterShader shader, Matrix4f projectionMatrix,
		...
		this.shader = shader;
		this.fbos = fbos;
		this.dudvTexture = loader.loadGameTexture(DUDV_MAP);
		this.normalMap = loader.loadGameTexture(NORMAL_MAP);
		shader.start();
	...
	private void prepareRender(Camera camera, Light sun){
		...
		moveFactor %= 1;
		shader.loadPlaneDistances(MasterRenderer.NEAR_PLANE,
				MasterRenderer.FAR_PLANE);
